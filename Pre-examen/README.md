...
### Objetivos y descrpciones generales
...
En este sentido, el fanzine no se define únicamente por su materialidad impresa, sino por el gesto que lo origina: el impulso humano de transmitir una vivencia, compartir una mirada personal sobre el mundo y generar vínculos desde la experiencia propia. Su valor no reside en seguir reglas editoriales tradicionales, sino precisamente en la posibilidad de existir fuera de ellas, apropiándose de los recursos disponibles para convertir la necesidad de comunicar en una acción creativa y afectiva.
